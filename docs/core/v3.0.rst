...
When using non-ASCII Unicode characters, we recommend users to only use
NFC-normalized immutible identifiers according to
`Unicode Standard Annex # 31 – Immutable Identifiers – UAX31-R2-1 <https://www.unicode.org/reports/tr31/#R2-1>`_.
Normalization form C is recommended for case-sensitive identifiers in
