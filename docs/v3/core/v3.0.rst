...
`storage_transformers <_storage_transformers_array_>`_ name in the `array metadata`_. Storage transformers which do
...
array       storage transformer     `storage_transformers_array`_
=========== ======================= ================================================
