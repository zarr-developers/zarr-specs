...
*Core*
    ...
    Core concepts refers to the Zarr v3 core specification as defined in this document
    not necessarily if something is a MUST for implementations.
...
1. **Raw names** MUST be assigned within a central repository and follow the
   ...
   The name assignment is managed through the `zarr-extensions 
   <https://github.com/zarr-developers/zarr-extensions>`_ Github
   repository, where each extension is
...
For extensions with raw names, the `zarr-extensions <https://github.com/zarr-developers/zarr-extensions>`_ repository
...
themselves under the `zarr-extensions <https://github.com/zarr-developers/zarr-extensions>`_ repository for better discovery.
...
- Clarification of extensions. `PR #TODO
  <https://github.com/zarr-developers/zarr-specs/pull/TODO/>`_. With this change,
