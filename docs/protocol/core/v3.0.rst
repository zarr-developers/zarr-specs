...
*Array*
    ...
    TODO: clarify how arrays with 0 dimension are store, and in particular what should be done WRT chunk naming, and how
    a 1d array of 1 elelement differs from a scalar.
...
Zarr v3.0 is limited to types lenght that are multiple of 8 bits but may open
other values in later version of the spec.
