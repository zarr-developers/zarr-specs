...
Specification URI:
    http://purl.org/zarr/spec/protocol/extensions/filters/1.0
Issue tracking:
    `GitHub issues <https://github.com/zarr-developers/zarr-specs/labels/filters-v1.0>`_
Suggest an edit for this spec:
    `GitHub editor <https://github.com/zarr-developers/zarr-specs/blob/core-protocol-v3.0-dev/docs/protocol/extension/filters/v1.0.rst>`_
...
This specification is a Zarr protocol extension defining a mechanism
